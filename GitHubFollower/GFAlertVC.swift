...
class GFAlertVC: UIViewController {
    ...
    func configureTitleLabel() {
        ...
        titleLabel.text = alertTitle ?? "Something went wrong"  // Basically: Use alertTitle, if alertTitle is nil, use this
    ...
    // order is important, since we are going to pin the button to the bottom, whe should configure ot first.
    ...
    // dismisses the alert from screen.
    @objc func dismissVC() {
